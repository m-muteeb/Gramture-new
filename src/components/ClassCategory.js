...
const DropdownComponent = () => {
  ...
  return (
    <Container className="my-5">
      <Row className="text-center mb-4">
        <Col>
          <h2 className="display-5 fw-bold text-dark">Gramture Study Platform</h2>
  ...
  {dropdownData.map((dropdown, index) => (
    <Col md={6} className="mb-3" key={index}>
      <Card className="card-custom  border-0 rounded-lg">
        <Card.Body>
          ...
          <Row className="mt-5 text-center">
            <Col>
              <h2 className="display-5 fw-bold text-dark">Recent Posts</h2>
            </Col>
          </Row>
      ...
      <h1 className="fw-bold text-xl mb-4 text-center mt-4">Why Grmature?</h1>
 ...
 <Col xs={12} sm={6} md={6} lg={6}>
        ...
        <Card className="card-elegant">
          ...
          <Card.Body>
            <Card.Title className=''>Important Questions & Answers</Card.Title>
            <Card.Text>
...
<h2 className="fw-bold text-3xl mb-6 text-center mb-3 text-dark">How Gramture Helps in Exam Preparation?</h2>
